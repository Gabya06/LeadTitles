...
# os.chdir("C:\SalesOps\LeadTitleScoreIntegration")
# project_dir = 'C:\\SalesOps\\LeadTitleScoreIntegration\\'
...
for rec in qr:
    ...
    rec_update = {'Id': lead_id, 'Title': original_title, 'Title_Score__c': score, 'type': 'Lead'}
